...
def Ajouter():
    ...
    try:
        ...
        if(a=="" or b=="" or c=="" or d=="" or e==""):
            ...
            sql = "INSERT INTO  Personnel (Nom, Prenoms,Rôle, Contact,Sexe) VALUES (%s, %s, %s, %s,%s)"
            value = (a, b, c, d,e)
            ...
            yann.say("Enregistrement du personnel  réussi")
            yann.runAndWait()
...
var0 = Ctk.CTkLabel(new,text="GESTION DU PERSONNEL", font=("Helvetica",36))
...
Affichage = ttk.Treeview(new,columns=(1,2,3,4,5,6),height=6,show="headings")
Affichage.place(x=650,y=330,height=620,width=1250)


Affichage.heading(1,text="Id_Personnel")
Affichage.heading(2,text="Nom")
Affichage.heading(3,text="Prenoms")
Affichage.heading(4,text="Rôle")
Affichage.heading(5,text="Contact")
Affichage.heading(6,text="Sexe")
...
curseur.execute("SELECT * FROM public.personnel  ORDER BY id_personnel ASC  ")
